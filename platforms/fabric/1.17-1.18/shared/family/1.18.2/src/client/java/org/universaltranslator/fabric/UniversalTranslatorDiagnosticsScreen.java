...
final class UniversalTranslatorDiagnosticsScreen extends Screen {
    ...
    protected void init() {
        ...
        addDrawableChild(ButtonWidget.builder(
                new TranslatableText("screen.universal_translator.diagnostics.back"), button -> close())
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        for (String line : lines) {
            drawTextWithShadow(matrices, textRenderer, new LiteralText(line), left, y, 0xFFD0D0D0);
            y += 17;
        }
